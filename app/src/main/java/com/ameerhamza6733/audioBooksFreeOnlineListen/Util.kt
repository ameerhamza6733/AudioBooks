...
//    val gaboora_URL = "https://archive.org/advancedsearch.php?q=collection%3A%22audio_bookspoetry%22+AND+mediatype%3Aaudio&fl[]=avg_rating&fl[]=publisher&fl[]=description&fl[]=downloads&fl[]=identifier&fl[]=mediatype&fl[]=num_reviews&fl[]=title&sort[]=-downloads&sort[]=&sort[]=&rows=100&page=1&output=json&callback=callback&save=yes"
    ...
    fun BuildQuery(catalogue : String) : String{
        return "https://archive.org/advancedsearch.php?q=subject%3A%22"+catalogue+"%22+AND+mediatype%3Aaudio&fl[]=avg_rating&fl[]=publisher&fl[]=description&fl[]=downloads&fl[]=identifier&fl[]=mediatype&fl[]=num_reviews&fl[]=creator&fl[]=title&sort[]=&sort[]=&sort[]=&rows=500&page=1&output=json&callback=callback&save=yes"
    }
    ...
    fun quraryBuilder(queary : String) : String{
        return "https://archive.org/advancedsearch.php?q=title%3A%22"+queary+"%22+AND+mediatype%3Aaudio&fl[]=avg_rating&fl[]=publisher&fl[]=description&fl[]=downloads&fl[]=identifier&fl[]=mediatype&fl[]=num_reviews&fl[]=title&sort[]=&sort[]=&sort[]=&rows=500&page=1&output=json&callback=callback&save=yes"
    }
    fun qurarySortBuilder(queary : String,sort : String) : String{
        return "https://archive.org/advancedsearch.php?q=title%3A%22"+queary+"%22+AND+mediatype%3Aaudio&fl[]=avg_rating&fl[]=publisher&fl[]=description&fl[]=downloads&fl[]=identifier&fl[]=mediatype&fl[]=num_reviews&fl[]=title&sort[]=&sort[]="+sort+"&sort[]=&rows=500&page=1&output=json&callback=callback&save=yes"
    }
